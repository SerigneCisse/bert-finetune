...
"bash -c 'git clone --depth 1 https://github.com/NVAITC/bert-finetune && cd bert-finetune && cp benchmark_scripts/bertbase_training_32.py run_script.py && python3 run_script.py'" \
...
"bash -c 'git clone --depth 1 https://github.com/NVAITC/bert-finetune && cd bert-finetune && cp benchmark_scripts/bertbase_training.py run_script.py && python3 run_script.py'" \
--result /results --org nvidian --team sae
